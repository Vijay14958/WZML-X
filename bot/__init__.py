...
BOT_TOKEN = environ.get('BOT_TOKEN', '6627318053:AAHhqT5sRkvPO9GpKRt-mAIQCPv1hBcDT4g')
if len(BOT_TOKEN) == 0:
...
DATABASE_URL = environ.get('DATABASE_URL', 'mongodb+srv://mihaja5084:yeIh95RrMkRNZ3It@cluster0.6voc3fm.mongodb.net/?retryWrites=true&w=majority')
...
OWNER_ID = environ.get('OWNER_ID', '6073523936')
if len(OWNER_ID) == 0:
...
TELEGRAM_API = environ.get('TELEGRAM_API', '22182189')
...
TELEGRAM_HASH = environ.get('TELEGRAM_HASH', '5e7c4088f8e23d0ab61e29ae11960bf5')
...
RSS_CHAT = environ.get('RSS_CHAT', '-1002131110143')
...
BASE_URL = environ.get('BASE_URL', 'http://increased-malissa-techvj-11b4159f.koyeb.app').rstrip("/")
if len(BASE_URL) == 0:
